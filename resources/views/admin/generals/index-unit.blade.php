        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="exampleModalCenterTitle"> รายการ </h3>
...
$("#item_list_table").ready(function () {
     item_list_table = $('#item_list_table').DataTable({
        ...
        "ajax": {
            "url": "/generals/manage-units/show",
            "method": "POST",
            "data": {
                "_token": "{{ csrf_token()}}",
            },
...
$('#storeBtn').click(function(){
    ...
    if(name == ''){
        ...
        $.post("/generals/manage-units/store", data = {
                    _token: '{{ csrf_token() }}',
                    name: name,
                    id: id,
            },
...
function deleteItem(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.post("/generals/manage-units/delete", data = {
                    _token: '{{ csrf_token() }}',
                    id: id,
                },
                function (res) {
